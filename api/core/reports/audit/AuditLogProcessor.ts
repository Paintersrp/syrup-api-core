...
import { ActionCounts, AuditLogMetrics, MetricKey, ModelRecord, NestedActionCounts } from './types';
...
export class AuditLogProcessor {
   ...
   */
  public processBatch(batch: AuditLog<any, any>[], metrics: AuditLogMetrics): void {
