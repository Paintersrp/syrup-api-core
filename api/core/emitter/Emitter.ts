...
import { ConditionFunction, EmitterData, EmitterListener, EmitterMiddleware } from './types';
...
export class Emitter {
   ...
   */
  public use(middleware: EmitterMiddleware): this {
   ...
   */
  public off(event: string, listener: EmitterListener): this {
    if (event === '*') {
   ...
   */
  public getEvents(): Map<string, EmitterData[]> {
