  ...
  return (
    <Page>
      <section css={styles.heroSection}>
        <h1 css={styles.heroTitle}>Welcome Bic Boi</h1>
        <p>Your one-stop solution for seamless application development.</p>
      </section>
      <section css={styles.featured}>
        <h2 css={styles.sectionTitle}>Featured Products</h2>
